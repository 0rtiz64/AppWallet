...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-lg"><b>App</b>Wallet</span>
    </a>
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                  ...
                  <small>MIEMBRO DESDE <?php   echo $_SESSION['fechaInicio'];?></small>
                </p>
              </li>
              <!-- Menu Body -->
              <li class="user-body">
              ...
              <li class="user-footer">
                ...
                <div class="pull-right">
                  <input class="btn btn-default btn-flat" value="SALIR" onclick="cerrar()"/>
                </div>
              </li>
            </ul>
          </li>
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy; 2018 <a href="#">David Ortiz</a>.</strong> All rights reserved.
  </footer>
